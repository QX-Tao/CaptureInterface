...
public class AppDialogManager {
    ...
    private void showDialog(Activity activity,
        ...
        LinearLayout llPermission = view.findViewById(R.id.ll_base_dialog);
        TextView tvTitle = view.findViewById(R.id.tv_dialog_title);
        TextView tvContent = view.findViewById(R.id.tv_dialog_content);
        tvContent.setMovementMethod(ScrollingMovementMethod.getInstance());
        TextView rtvLeft = view.findViewById(R.id.tv_left);
        TextView rtvRight = view.findViewById(R.id.tv_right);
        //处理圆角
        ViewOutlineProvider viewOutlineProvider;
        viewOutlineProvider = new ViewOutlineProvider(){
            @Override
            public void getOutline(View view, Outline outline) {
                outline.setRoundRect(0, 0, llPermission.getWidth(), llPermission.getHeight(), 30);
            }
        };
        llPermission.setOutlineProvider(viewOutlineProvider);
        llPermission.setClipToOutline(true);
        //显示title逻辑
